    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 px-6 text-white">
                ...
                <h1 className="text-left text-3xl mb-2 font-bold md:text-4xl lg:text-6xl xl:text-8xl">Seminario Internacional de Judo con Moacir Méndez</h1>
                ...
                <h2 className="text-left text-sm sm:text-xl md:text-2xl lg:text-4xl">21 de Marzo de 2026</h2>
